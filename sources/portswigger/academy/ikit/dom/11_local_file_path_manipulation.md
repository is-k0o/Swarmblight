...
agent: ikit
topic: dom
subtopic: "local-file-path-manipulation"
source_type: academy
source_title: "DOM-based local file-path manipulation"
source_reference: "https://portswigger.net/web-security/dom-based/local-file-path-manipulation"
