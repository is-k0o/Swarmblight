...
agent: ikit
topic: dom
subtopic: "javascript-injection"
source_type: academy
source_title: "DOM-based JavaScript injection"
source_reference: "https://portswigger.net/web-security/dom-based/javascript-injection"
...
In addition to the general measures described on the DOM-based vulnerabilities page, you should avoid allowing data from any untrusted source to be executed as JavaScript.
