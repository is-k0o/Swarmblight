...
agent: ikit
topic: dom
subtopic: "web-message-source"
source_type: academy
source_title: "Controlling the web message source"
source_reference: "https://portswigger.net/web-security/dom-based/controlling-the-web-message-source"
