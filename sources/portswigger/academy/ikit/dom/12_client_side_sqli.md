...
agent: ikit
topic: dom
subtopic: "client-side-sqli"
source_type: academy
source_title: "DOM-based client-side SQL injection"
source_reference: "https://portswigger.net/web-security/dom-based/client-side-sql-injection"
