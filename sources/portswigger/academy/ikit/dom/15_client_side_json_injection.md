...
agent: ikit
topic: dom
subtopic: "client-side-json-injection"
source_type: academy
source_title: "DOM-based client-side JSON injection"
source_reference: "https://portswigger.net/web-security/dom-based/client-side-json-injection"
