...
agent: ikit
topic: dom
subtopic: "ajax-request-header-manipulation"
source_type: academy
source_title: "DOM-based Ajax request-header manipulation"
source_reference: "https://portswigger.net/web-security/dom-based/ajax-request-header-manipulation"
corpus: ikit_dom_core_v1
---
...
In addition to the general measures described on the DOM-based vulnerabilities page, you should avoid allowing data from any untrusted source dynamically set Ajax request headers.
